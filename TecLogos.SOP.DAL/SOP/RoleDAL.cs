...
namespace TecLogos.SOP.DAL.SOP
{
    public interface IRoleDAL
    {
        ...
        Task<Guid> Create(Role role, Guid userId);
        Task<bool> Update(Role role, Guid userId);
    ...
    public class RoleDAL : IRoleDAL
    {
        ...
        public RoleDAL(IConfiguration configuration, ILogger<RoleDAL> logger)
        {
        ...
        public async Task<Guid> Create(Role role, Guid userId)
        {
        ...
        public async Task<bool> Update(Role role, Guid userId)
        {
            const string query = @"
                UPDATE [Role]
                SET Name         = @Name,
