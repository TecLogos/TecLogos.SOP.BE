...
namespace TecLogos.SOP.DAL.SOP
{
    ...
    public class SopDetailDAL : ISopDetailDAL
    {
        ...
        {
            const string sql = @"
                SELECT ID, SopDetailsID, ApprovalLevel, ApprovalStatus, Remarks,
        ...
        public async Task AddApprovalHistoryAsync(SopDetailsApprovalHistory approval)
        {
            const string sql = @"
                ...
                (ID, SopDetailsID, ApprovalLevel, ApprovalStatus, Remarks,
                 ReferenceVersion, CreatedByID)
                VALUES
                (NEWID(), @SopID, @Level, @Status, @Remarks, @RefVersion, @CreatedBy)";
            ...
            cmd.Parameters.AddWithValue("@Remarks", approval.Remarks ?? (object)DBNull.Value);
        ...
        private static SopDetails MapSop(SqlDataReader r) => new()
        {
            ...
            SopTitle = r.GetString(r.GetOrdinal("SopTitle")),
            ExpirationDate = r.GetDateTime(r.GetOrdinal("ExpirationDate")),
            SopDocument = r.GetString(r.GetOrdinal("SopDocument")),
            ...
            Modified = r.GetDateTime(r.GetOrdinal("Modified")),
            ModifiedByID = r.GetGuid(r.GetOrdinal("ModifiedByID")),
            Deleted = r.GetDateTime(r.GetOrdinal("Deleted")),
            DeletedByID = r.GetGuid(r.GetOrdinal("DeletedByID"))
        };
